...
import { DOCTORS_KITCHEN_RECIPES } from "@/data/doctors-kitchen-recipes";
import { GLUCOSE_REVOLUTION_RECIPES, GLUCOSE_REVOLUTION_SNACK_RECIPES } from "@/data/glucose-revolution-recipes";
import { HOW_NOT_TO_DIET_RECIPES, HOW_NOT_TO_DIET_SNACK_RECIPES } from "@/data/how-not-to-diet-recipes";

/** All meal recipes (not baking) */
export const ALL_MEAL_RECIPES: Recipe[] = [...RECIPES, ...PDF_RECIPES, ...LIBRARY_RECIPES, ...STORAGE_PDF_RECIPES, ...EXPANDED_RECIPES, ...PLANT_POWERED_RECIPES, ...PLANT_POWERED_PLUS_RECIPES, ...TCM_AYURVEDA_RECIPES, ...MEAL_PLAN_RECIPES, ...BOWL_MEAL_RECIPES, ...VEGAN_BASICS_RECIPES, ...PROTEIN_15_RECIPES, ...EXTRA_BATCH_MEAL_RECIPES, ...DOCTORS_KITCHEN_RECIPES, ...GLUCOSE_REVOLUTION_RECIPES, ...HOW_NOT_TO_DIET_RECIPES];

/** All recipes including baking and snacks */
export const ALL_RECIPES: Recipe[] = [...ALL_MEAL_RECIPES, ...BAKING_RECIPES, ...SNACK_DESSERT_RECIPES, ...EXTRA_BATCH_SNACK_RECIPES, ...GLUCOSE_REVOLUTION_SNACK_RECIPES, ...HOW_NOT_TO_DIET_SNACK_RECIPES];
