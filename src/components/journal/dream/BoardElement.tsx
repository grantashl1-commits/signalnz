...
const TYPE_THEMES: Record<string, {
  ...
  text: {
    bg: "#fefdfb",
    border: "hsl(32 25% 90%)",
    borderSelected: "hsl(32 35% 78%)",
    label: "hsl(25 18% 60%)",
    accent: "hsl(32 35% 78%)",
    shadow: "0 1px 3px hsl(30 20% 50% / 0.05), 0 4px 14px -4px hsl(30 20% 50% / 0.07)",
    shadowSelected: "0 8px 30px -6px hsl(30 25% 50% / 0.15), 0 2px 8px -2px hsl(30 20% 50% / 0.08)",
  },
  quote: {
    bg: "#fdfbfe",
    border: "hsl(284 15% 90%)",
    borderSelected: "hsl(284 20% 74%)",
    label: "hsl(284 20% 55%)",
    accent: "hsl(284 22% 44%)",
    shadow: "0 1px 3px hsl(284 15% 40% / 0.04), 0 4px 14px -4px hsl(284 15% 40% / 0.06)",
    shadowSelected: "0 8px 30px -6px hsl(284 22% 44% / 0.14), 0 2px 8px -2px hsl(284 22% 44% / 0.06)",
  },
  goal: {
    bg: "#fbfafe",
    border: "hsl(258 18% 90%)",
    borderSelected: "hsl(258 25% 74%)",
    label: "hsl(258 30% 52%)",
    accent: "hsl(258 36% 49%)",
    shadow: "0 1px 3px hsl(258 15% 40% / 0.04), 0 4px 14px -4px hsl(258 15% 40% / 0.06)",
    shadowSelected: "0 8px 30px -6px hsl(258 36% 49% / 0.14), 0 2px 8px -2px hsl(258 36% 49% / 0.06)",
  },
  affirmation: {
    bg: "#fefbfc",
    border: "hsl(340 14% 90%)",
    borderSelected: "hsl(340 22% 76%)",
    label: "hsl(340 25% 58%)",
    accent: "hsl(340 28% 62%)",
    shadow: "0 1px 3px hsl(340 15% 40% / 0.04), 0 4px 14px -4px hsl(340 15% 40% / 0.05)",
    shadowSelected: "0 8px 30px -6px hsl(340 28% 55% / 0.12), 0 2px 8px -2px hsl(340 28% 55% / 0.06)",
  },
  prompt: {
    bg: "#fcfafe",
    border: "hsl(284 10% 90%)",
    borderSelected: "hsl(284 18% 76%)",
    label: "hsl(284 20% 55%)",
    accent: "hsl(284 22% 44%)",
    shadow: "0 1px 3px hsl(284 12% 40% / 0.04), 0 4px 14px -4px hsl(284 12% 40% / 0.05)",
    shadowSelected: "0 8px 30px -6px hsl(284 22% 44% / 0.12), 0 2px 8px -2px hsl(284 22% 44% / 0.06)",
  },
  image: {
    bg: "#fefdfb",
    border: "hsl(25 18% 90%)",
    borderSelected: "hsl(25 22% 76%)",
    label: "hsl(25 18% 62%)",
    accent: "hsl(25 22% 76%)",
    shadow: "0 2px 6px hsl(25 15% 30% / 0.06), 0 6px 20px -4px hsl(25 15% 30% / 0.08)",
    shadowSelected: "0 10px 34px -8px hsl(25 15% 30% / 0.16), 0 4px 12px -2px hsl(25 15% 30% / 0.08)",
  },
  label: {
    bg: "transparent",
    border: "transparent",
