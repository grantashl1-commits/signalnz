...
const QUIZ_PAIRS: QuizPair[] = [
  ...
  // "It's more meaningful to me when..." style pairs (Love Nudge framing)
  { a: { text: "I receive a loving note, text, or email for no special reason from my loved one.", lang: "words" }, b: { text: "my partner and I hug.", lang: "touch" } },
  { a: { text: "I can spend alone time with my partner — just the two of us.", lang: "time" }, b: { text: "my partner does something practical to help me out.", lang: "service" } },
  { a: { text: "my partner gives me a little gift as a token of our love for each other.", lang: "gifts" }, b: { text: "I get to spend uninterrupted leisure time with my partner.", lang: "time" } },
  { a: { text: "my partner unexpectedly does something for me like filling my car or doing the laundry.", lang: "service" }, b: { text: "my partner and I touch.", lang: "touch" } },
  { a: { text: "my partner puts his or her arm around me when we're in public.", lang: "touch" }, b: { text: "my partner surprises me with a gift.", lang: "gifts" } },
  { a: { text: "I'm around my partner, even if we're not really doing anything.", lang: "time" }, b: { text: "I hold hands with my partner.", lang: "touch" } },
  { a: { text: "my partner gives me a gift.", lang: "gifts" }, b: { text: "I hear 'I love you' from my partner.", lang: "words" } },
  { a: { text: "I sit close to my partner.", lang: "touch" }, b: { text: "I am complimented by my loved one for no apparent reason.", lang: "words" } },
  { a: { text: "I get the chance to just 'hang out' with my partner.", lang: "time" }, b: { text: "I unexpectedly get small gifts from my partner.", lang: "gifts" } },
  { a: { text: "my partner tells me they believe in me.", lang: "words" }, b: { text: "my partner helps me with a task I'm dreading.", lang: "service" } },
  { a: { text: "my partner kisses me unexpectedly.", lang: "touch" }, b: { text: "my partner brings me a small gift after they've been away.", lang: "gifts" } },
  { a: { text: "my partner takes care of something I'm responsible for, like a household chore.", lang: "service" }, b: { text: "my partner expresses how much I mean to them.", lang: "words" } },
  { a: { text: "my partner and I share an activity we both enjoy.", lang: "time" }, b: { text: "my partner places their hand on my back or shoulder.", lang: "touch" } },
  { a: { text: "my partner reacts positively to a gift I give them.", lang: "gifts" }, b: { text: "my partner says how proud they are of me.", lang: "words" } },
  { a: { text: "my partner cooks a meal for me.", lang: "service" }, b: { text: "my partner makes plans for the two of us to be alone together.", lang: "time" } },
  { a: { text: "my partner gives me a thoughtful card.", lang: "words" }, b: { text: "my partner cuddles with me on the couch.", lang: "touch" } },
  { a: { text: "my partner takes the initiative to fix something around the home.", lang: "service" }, b: { text: "my partner gives me a 'just because' gift.", lang: "gifts" } },
  { a: { text: "my partner makes me a hot drink without me asking.", lang: "service" }, b: { text: "my partner and I have a long conversation.", lang: "time" } },
  { a: { text: "my partner massages my shoulders or feet.", lang: "touch" }, b: { text: "my partner thanks me for something I've done.", lang: "words" } },
  { a: { text: "my partner shows interest in something that matters to me.", lang: "time" }, b: { text: "my partner picks up something I mentioned wanting.", lang: "gifts" } },
  { a: { text: "my partner praises me in front of others.", lang: "words" }, b: { text: "my partner takes care of me when I'm unwell.", lang: "service" } },
  { a: { text: "my partner and I lie close together.", lang: "touch" }, b: { text: "my partner makes time to do something I want to do.", lang: "time" } },
  { a: { text: "my partner gives me a meaningful birthday or anniversary present.", lang: "gifts" }, b: { text: "my partner notices my efforts and tells me so.", lang: "words" } },
  { a: { text: "my partner takes something off my plate without being asked.", lang: "service" }, b: { text: "my partner reaches for my hand spontaneously.", lang: "touch" } },
  { a: { text: "my partner plans a special evening just for us.", lang: "time" }, b: { text: "my partner sends me an encouraging message during the day.", lang: "words" } },
  { a: { text: "my partner brings me my favourite snack or coffee.", lang: "gifts" }, b: { text: "my partner runs a bath or sets up a cozy space for me.", lang: "service" } },
  { a: { text: "my partner kisses me on the forehead.", lang: "touch" }, b: { text: "my partner sets aside time for a deep, uninterrupted talk.", lang: "time" } },
