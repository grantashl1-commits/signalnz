...
import kidsChickenPasta from "./kids-chicken-pasta.jpg";
import kidsBeefMeatballs from "./kids-beef-meatballs.jpg";
import kidsBeefTacos from "./kids-beef-tacos.jpg";
import kidsBeefBolognese from "./kids-beef-bolognese.jpg";
import kidsBeefRiceBowl from "./kids-beef-rice-bowl.jpg";
import kidsFishFingers from "./kids-fish-fingers.jpg";
import kidsSalmonPasta from "./kids-salmon-pasta.jpg";
import kidsTunaRice from "./kids-tuna-rice.jpg";
import kidsTofuNuggets from "./kids-tofu-nuggets.jpg";
import kidsTofuStirFry from "./kids-tofu-stir-fry.jpg";
import kidsBeanQuesadilla from "./kids-bean-quesadilla.jpg";
import kidsLentilPasta from "./kids-lentil-pasta.jpg";
import kidsChickpeaCurry from "./kids-chickpea-curry.jpg";
import kidsBeanNachos from "./kids-bean-nachos.jpg";
import kidsEggFriedRice from "./kids-egg-fried-rice.jpg";
import kidsFrittata from "./kids-frittata.jpg";
...
import kidsPaleoBananaMuffins from "./kids-paleo-banana-muffins.jpg";
import kidsPaleoSweetPotatoPancakes from "./kids-paleo-sweet-potato-pancakes.jpg";
import kidsPaleoVeggieScramble from "./kids-paleo-veggie-scramble.jpg";
import kidsPaleoBreakfastHash from "./kids-paleo-breakfast-hash.jpg";
import kidsPaleoOvenPancake from "./kids-paleo-oven-pancake.jpg";
import kidsPaleoChickenStrips from "./kids-paleo-chicken-strips.jpg";
import kidsPaleoTurkeyBurgers from "./kids-paleo-turkey-burgers.jpg";
import kidsPaleoChickenFajitas from "./kids-paleo-chicken-fajitas.jpg";
import kidsPaleoTunaNoriRolls from "./kids-paleo-tuna-nori-rolls.jpg";
import kidsPaleoMeatballSkewers from "./kids-paleo-meatball-skewers.jpg";
import kidsPaleoStuffedPeppers from "./kids-paleo-stuffed-peppers.jpg";
import kidsPaleoShepherdsPie from "./kids-paleo-shepherds-pie.jpg";
import kidsPaleoPulledPork from "./kids-paleo-pulled-pork.jpg";
import kidsPaleoBeefStew from "./kids-paleo-beef-stew.jpg";
import kidsPaleoMeatloaf from "./kids-paleo-meatloaf.jpg";
import kidsPaleoLambChops from "./kids-paleo-lamb-chops.jpg";
import kidsPaleoEggplantLasagna from "./kids-paleo-eggplant-lasagna.jpg";
import kidsPaleoCurriedPork from "./kids-paleo-curried-pork.jpg";
...
import kidsAkPinwheelWraps from "./kids-ak-pinwheel-wraps.jpg";
import kidsAkPastaSaladPots from "./kids-ak-pasta-salad-pots.jpg";
import kidsAkMiniMeatloafCups from "./kids-ak-mini-meatloaf-cups.jpg";
import kidsAkSweetPotatoFingers from "./kids-ak-sweet-potato-fingers.jpg";
import kidsAkOnePotPasta from "./kids-ak-one-pot-pasta.jpg";
import kidsAkSpeedyChickenWraps from "./kids-ak-speedy-chicken-wraps.jpg";
// America's Test Kitchen
import kidsAtkSmashBurgers from "./kids-atk-smash-burgers.jpg";
import kidsAtkCrispyQuesadilla from "./kids-atk-crispy-quesadilla.jpg";
import kidsAtkSheetPanNachos from "./kids-atk-sheet-pan-nachos.jpg";
import kidsAtkStickyDrumsticks from "./kids-atk-sticky-drumsticks.jpg";
import kidsAtkCheeseBread from "./kids-atk-cheese-bread.jpg";
// Ava Archer
import kidsAaRainbowSkewers from "./kids-aa-rainbow-skewers.jpg";
import kidsAaPizzaScrolls from "./kids-aa-pizza-scrolls.jpg";
import kidsAaBananaPancakeFaces from "./kids-aa-banana-pancake-faces.jpg";
import kidsAaAntsOnALog from "./kids-aa-ants-on-a-log.jpg";
import kidsAaChickenPopcorn from "./kids-aa-chicken-popcorn.jpg";
import kidsAaCheeseStars from "./kids-aa-cheese-stars.jpg";
// Bryton Taylor
import kidsBtDragonNoodles from "./kids-bt-dragon-noodles.jpg";
import kidsBtFairyBreadToast from "./kids-bt-fairy-bread-toast.jpg";
// Naturally Nourished Kids
import kidsNnEnergyBalls from "./kids-nn-energy-balls.jpg";
import kidsNnSweetPotatoWaffles from "./kids-nn-sweet-potato-waffles.jpg";
import kidsNnTurkeyVeggieMuffins from "./kids-nn-turkey-veggie-muffins.jpg";
// Little Helpers Toddler
import kidsLhBananaOatCookies from "./kids-lh-banana-oat-cookies.jpg";
import kidsLhAvocadoToastFaces from "./kids-lh-avocado-toast-faces.jpg";
import kidsLhMiniPizzas from "./kids-lh-mini-pizzas.jpg";
// Buddy Oliver
import kidsBoFishGoujonWraps from "./kids-bo-fish-goujon-wraps.jpg";
import kidsBoPastaPestoPeas from "./kids-bo-pasta-pesto-peas.jpg";
import kidsBoChickenLollipops from "./kids-bo-chicken-lollipops.jpg";
// Olivia Rana
import kidsOrVeggieHummusWraps from "./kids-or-veggie-hummus-wraps.jpg";
import kidsOrTunaMeltPockets from "./kids-or-tuna-melt-pockets.jpg";
import kidsOrPastaMuffins from "./kids-or-pasta-muffins.jpg";
// Emma Jane Frost
import kidsEjSpaghettiNests from "./kids-ej-spaghetti-nests.jpg";
import kidsEjChickenGoujons from "./kids-ej-chicken-goujons.jpg";
...
import kidsDkDippableChicken from "./kids-dk-dippable-chicken.jpg";
// Kim McCosker
import kidsKmHamCheeseScrolls from "./kids-km-ham-cheese-scrolls.jpg";
import kidsKmCornFritters from "./kids-km-corn-fritters.jpg";
import kidsKmChocBananaPops from "./kids-km-choc-banana-pops.jpg";
// Sarah Wilson
...
export const KIDS_RECIPE_IMAGES: Record<string, string> = {
  ...
  "kids-chicken-pasta": kidsChickenPasta,
  "kids-beef-meatballs": kidsBeefMeatballs,
  "kids-beef-tacos": kidsBeefTacos,
  "kids-beef-bolognese": kidsBeefBolognese,
  "kids-beef-rice-bowl": kidsBeefRiceBowl,
  "kids-fish-fingers": kidsFishFingers,
  "kids-salmon-pasta": kidsSalmonPasta,
  "kids-tuna-rice": kidsTunaRice,
  "kids-tofu-nuggets": kidsTofuNuggets,
  "kids-tofu-stir-fry": kidsTofuStirFry,
  "kids-bean-quesadilla": kidsBeanQuesadilla,
  "kids-lentil-pasta": kidsLentilPasta,
  "kids-chickpea-curry": kidsChickpeaCurry,
  "kids-bean-nachos": kidsBeanNachos,
  "kids-egg-fried-rice": kidsEggFriedRice,
  ...
  "kids-paleo-breakfast-hash": kidsPaleoBreakfastHash,
  "kids-paleo-oven-pancake": kidsPaleoOvenPancake,
  "kids-paleo-chicken-strips": kidsPaleoChickenStrips,
  "kids-paleo-turkey-burgers": kidsPaleoTurkeyBurgers,
  "kids-paleo-chicken-fajitas": kidsPaleoChickenFajitas,
  "kids-paleo-tuna-nori-rolls": kidsPaleoTunaNoriRolls,
  "kids-paleo-meatball-skewers": kidsPaleoMeatballSkewers,
  "kids-paleo-stuffed-peppers": kidsPaleoStuffedPeppers,
  "kids-paleo-shepherds-pie": kidsPaleoShepherdsPie,
  "kids-paleo-pulled-pork": kidsPaleoPulledPork,
  "kids-paleo-beef-stew": kidsPaleoBeefStew,
  "kids-paleo-meatloaf": kidsPaleoMeatloaf,
  "kids-paleo-lamb-chops": kidsPaleoLambChops,
  "kids-paleo-eggplant-lasagna": kidsPaleoEggplantLasagna,
