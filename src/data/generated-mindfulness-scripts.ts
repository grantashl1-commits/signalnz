...
const childhoodBlueprint: MeditationScript = {
  id: "gen-childhood-blueprint",
  title: "The Childhood Blueprint",
  subtitle: "Tracing patterns back to their origin",
  category: "inner-work",
  durationSec: 720,
  description: "A gentle guided reflection to explore how childhood coping strategies may have evolved into adult patterns. Understanding the origin softens the grip.",
  evidenceSource: "Developmental trauma research; IFS (Schwartz); Beyond Addiction (Foote et al.)",
  tags: ["addiction-recovery", "inner-work", "childhood", "coping", "self-compassion", "root-cause"],
  phase: "all",
  backgroundMusic: "binaural",
  ttsScript: \`Welcome to The Childhood Blueprint.
...
Today, you're going to travel gently backward in time. Not to relive anything painful, but to understand something important about yourself. You are here because you are brave enough to look.
...
These weren't flaws. They were strategies. Brilliant strategies for a child who had no other options.
...
You don't need to have a perfect insight right now. Just notice if something resonates. If something feels true in your body. Where do you feel it? Your chest? Your throat? Your stomach?
...
"You don't have to protect me in that way anymore."
"I am here now. I can take care of us."

Let these words settle. Feel whatever comes. Grief, tenderness, relief. It's all welcome here.
...
When you're ready, gently open your eyes. Carry this understanding with you softly.\`,
  steps: [
    { id: "s1", title: "Ground & Settle", body: "Breath work and intention setting.", startTimeSec: 0, endTimeSec: 90 },
    { id: "s2", title: "Recall Childhood", body: "Explore the emotional atmosphere of early life.", startTimeSec: 90, endTimeSec: 240 },
    { id: "s3", title: "Identify Strategies", body: "Recognise childhood coping as intelligence.", startTimeSec: 240, endTimeSec: 380 },
    { id: "s4", title: "Connect the Thread", body: "Link childhood strategies to adult patterns.", startTimeSec: 380, endTimeSec: 500 },
    { id: "s5", title: "Speak to the Child", body: "Offer words of understanding to younger self.", startTimeSec: 500, endTimeSec: 650 },
    { id: "s6", title: "Close", body: "Integrate with compassion.", startTimeSec: 650, endTimeSec: 720 },
  ],
};

const shameInventory: MeditationScript = {
  id: "gen-shame-inventory",
  title: "The Shame Inventory",
  subtitle: "Gently releasing shame that fuels cycles",
  category: "inner-work",
  durationSec: 600,
  description: "A compassionate guided practice to identify shame that feeds addictive cycles, and begin to separate your identity from your behaviour.",
  evidenceSource: "Brené Brown shame resilience theory; Beyond Addiction (Foote et al.)",
  tags: ["addiction-recovery", "inner-work", "shame", "self-worth", "identity", "self-compassion"],
  phase: "all",
  backgroundMusic: "gentle",
  ttsScript: \`Welcome to The Shame Inventory.

Find a comfortable, private place where you won't be disturbed. This practice asks for honesty, and honesty needs safety. So make sure you feel safe right now.
...
Shame is one of the most powerful forces in the human experience. It whispers that something is fundamentally wrong with you. Not that you made a mistake, but that you are a mistake. And that whisper... it fuels the very cycles you're trying to break.

Today, you're going to look at shame directly. Not to wallow in it. But to take its power away.

Think of something you feel ashamed about. A behaviour. A moment. A pattern. Something you've hidden from others, or even from yourself.
...
That's shame talking. And right now, you're going to do something radical. You're going to stay.

Shame survives in secrecy and silence. It loses its power the moment it's seen with compassion. So let's see it.
...
Even the things we're most ashamed of often started as attempts to survive. They deserve understanding, even as you choose to move beyond them.

Imagine gathering this shame... like a heavy stone you've been carrying. Feel its weight. You've been carrying it for so long.
...
You are worthy of compassion. Not because you're perfect. Because you're human.

When you're ready, gently open your eyes.\`,
  steps: [
    { id: "s1", title: "Create Safety", body: "Settle and establish a safe inner space.", startTimeSec: 0, endTimeSec: 90 },
    { id: "s2", title: "Name the Shame", body: "Bring a specific shame to awareness.", startTimeSec: 90, endTimeSec: 200 },
    { id: "s3", title: "Stay Present", body: "Notice the body's response without fleeing.", startTimeSec: 200, endTimeSec: 300 },
    { id: "s4", title: "Separate Identity", body: "You are not your behaviour.", startTimeSec: 300, endTimeSec: 420 },
    { id: "s5", title: "Set It Down", body: "Visualise releasing the weight of shame.", startTimeSec: 420, endTimeSec: 540 },
    { id: "s6", title: "Close", body: "Affirm worth and open eyes.", startTimeSec: 540, endTimeSec: 600 },
  ],
};

const emotionalLandscape: MeditationScript = {
  id: "gen-emotional-landscape",
  title: "Mapping Your Emotional Landscape",
  subtitle: "Discover which feelings you avoid",
  category: "inner-work",
  durationSec: 480,
  description: "Identify the specific emotions you struggle to feel, and how avoidance of those emotions drives habitual or compulsive behaviour.",
  evidenceSource: "Emotional literacy frameworks; ACT (Hayes); Brianna Wiest, The Human Element",
  tags: ["addiction-recovery", "inner-work", "emotions", "avoidance", "awareness", "self-inquiry"],
  phase: "all",
  backgroundMusic: "gentle",
  ttsScript: \`Welcome to Mapping Your Emotional Landscape.
...
Today, you're going to explore your relationship with your own emotions. Not to judge, but to map. To understand which feelings you welcome, and which ones you've learned to run from.
...
Let's explore those quieter corners.
...
Grief. For things lost, for things that never were, for the person you thought you'd become. Is there grief you haven't fully felt?

Now... here is the key insight. The emotions we avoid... are often the ones that drive our most compulsive behaviours. We reach for food, for screens, for substances, for distraction... not because we're weak, but because we're trying not to feel something specific.

What emotion are you most afraid to feel? Sit with that question. Don't rush to answer. Let your body tell you.

Where do you feel the avoidance? Is it a wall in your chest? A locked door in your belly? A turning away in your mind?

What if you didn't have to feel it all at once? What if you could just... acknowledge it exists? Just say: "I know you're there. I'm not ready to feel you fully yet, and that's okay. But I see you."

That acknowledgment alone begins to change the pattern. Because the pattern was built on pretending the feeling didn't exist.

Take a breath. A deep, honest breath. You've just mapped something important.

You don't need to be an expert in your emotions. You just need to be willing to notice them. That willingness is everything.

When you're ready, gently open your eyes.\`,
  steps: [
    { id: "s1", title: "Settle", body: "Ground and visualise emotional landscape.", startTimeSec: 0, endTimeSec: 80 },
    { id: "s2", title: "Familiar Territory", body: "Identify emotions you visit often.", startTimeSec: 80, endTimeSec: 150 },
    { id: "s3", title: "The Avoided", body: "Explore sadness, loneliness, vulnerability, grief.", startTimeSec: 150, endTimeSec: 300 },
    { id: "s4", title: "The Connection", body: "Link avoidance to compulsive behaviour.", startTimeSec: 300, endTimeSec: 400 },
    { id: "s5", title: "Acknowledge", body: "See the feeling without forcing it.", startTimeSec: 400, endTimeSec: 480 },
  ],
};

const letterNeverSent: MeditationScript = {
  id: "gen-letter-never-sent",
  title: "The Letter You Never Sent",
  subtitle: "A meditation-journaling hybrid for release",
  category: "inner-work",
  durationSec: 900,
  description: "Mentally compose a letter to someone connected to your pattern — a parent, a younger self, or anyone whose relationship shaped your coping. Deeply cathartic.",
  evidenceSource: "Narrative therapy (White & Epston); Gestalt empty-chair technique; Brianna Wiest",
  tags: ["addiction-recovery", "inner-work", "catharsis", "relationships", "grief", "forgiveness"],
  phase: "all",
  backgroundMusic: "binaural",
  ttsScript: \`Welcome to The Letter You Never Sent.

This is a deeply personal practice. You'll need privacy and time. There's no pressure to share what comes up. This is just for you.
...
Today, you're going to write a letter in your mind. Not on paper, not to send. A letter to someone connected to one of your patterns. This might be a parent. A partner. A friend. A younger version of yourself. Or even the pattern itself.

Take a moment to let a person come to mind. Don't overthink it. Trust the first person who appears. They're the right one for today.
...
Maybe it starts with something simple: "I've been carrying this for a long time."

Or maybe it's more direct: "You hurt me, and I never told you."
...
Let the words come. They don't need to be eloquent. They don't need to be fair. They just need to be true.

Pause here. Let the words form at their own pace. There's no rush.

...

What do you feel as these words take shape? Where in your body does this letter live? Is there heat? Tears? Tightness? Relief?

Stay with it. You're doing something incredibly brave right now.

...

Now, if it feels right... is there anything else? Something you've been protecting them from hearing? Something you've been protecting yourself from saying?
...
There's no correct ending. Only your ending.
...
You don't have to carry these unsaid words anymore.
...
When you're ready, gently open your eyes.\`,
  steps: [
    { id: "s1", title: "Ground", body: "Settle and set intention for deep honesty.", startTimeSec: 0, endTimeSec: 120 },
    { id: "s2", title: "Choose the Recipient", body: "Let someone connected to your pattern appear.", startTimeSec: 120, endTimeSec: 210 },
    { id: "s3", title: "Begin the Letter", body: "Let the unsaid words form.", startTimeSec: 210, endTimeSec: 450 },
    { id: "s4", title: "Go Deeper", body: "Say what you've been protecting.", startTimeSec: 450, endTimeSec: 650 },
    { id: "s5", title: "Release", body: "Fold and let the letter go.", startTimeSec: 650, endTimeSec: 820 },
    { id: "s6", title: "Close", body: "Hand on heart, affirm lightness.", startTimeSec: 820, endTimeSec: 900 },
  ],
};

const reclaimingPower: MeditationScript = {
  id: "gen-reclaiming-power",
  title: "Reclaiming Your Power",
  subtitle: "Choosing awareness over autopilot",
  category: "inner-work",
  durationSec: 600,
  description: "A forward-looking empowerment practice to identify what you gain control over when you choose awareness instead of autopilot. Hopeful, practical, grounding.",
  evidenceSource: "Self-Determination Theory (Deci & Ryan); ACT values work; Brianna Wiest, The Mountain Is You",
  tags: ["addiction-recovery", "inner-work", "empowerment", "agency", "values", "forward-looking"],
  phase: "all",
  backgroundMusic: "gentle",
  ttsScript: \`Welcome to Reclaiming Your Power.

Find a comfortable, upright position. Something that feels both relaxed and alert. You're not winding down. You're waking up.

Close your eyes. Take a breath that fills your entire chest. And exhale with intention. Like you're choosing to let go.

Again. Inhale choice... exhale old stories.

One more. Inhale possibility... exhale limitation.

You have been doing extraordinary work. Looking at patterns. Exploring roots. Sitting with discomfort. Naming shame. Feeling feelings you've avoided for years.

That takes more courage than most people will ever understand. And today, you're going to turn all of that awareness into something powerful. Into choice.
...
Let's get specific. Think about your pattern. The one you've been working with.
...
These aren't small things. These are the building blocks of a different life.
...
That person isn't someone else. That person is you... with six months of choices between here and there.
...
Your power isn't in never struggling. It's in what you do when the struggle arrives. And you're already doing it. Right now. By being here.

Take a deep, triumphant breath. You are choosing yourself. That is the most powerful thing a person can do.

When you're ready, open your eyes. And carry this knowing with you: you are not stuck. You are in motion. And every conscious choice is proof.\`,
  steps: [
    { id: "s1", title: "Arrive", body: "Alert, upright, intentional breathing.", startTimeSec: 0, endTimeSec: 90 },
    { id: "s2", title: "Acknowledge Courage", body: "Honour the work you've already done.", startTimeSec: 90, endTimeSec: 160 },
    { id: "s3", title: "Cost & Gain", body: "Name what autopilot costs and awareness gives.", startTimeSec: 160, endTimeSec: 300 },
    { id: "s4", title: "Future Self", body: "Visualise six months of conscious choices.", startTimeSec: 300, endTimeSec: 440 },
    { id: "s5", title: "The Question", body: "What do I actually want right now?", startTimeSec: 440, endTimeSec: 540 },
    { id: "s6", title: "Close", body: "Affirm power and open eyes.", startTimeSec: 540, endTimeSec: 600 },
  ],
};
