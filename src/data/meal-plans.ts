...
export const RECIPES: Recipe[] = [
  ...
  { id: "fermented-bowl", name: "Kimchi & Brown Rice Power Bowl", phase: "follicular", serves: 2, prepTime: "15 min", keyNutrients: ["Probiotics", "Complex carbs", "Zinc"], ingredients: ["Brown rice", "Kimchi", "Edamame", "Avocado", "Sesame"], method: ["Assemble bowl with warm rice.", "Top with fermented veg and toppings."], phaseBenefit: "Fermented foods support the estrobolome. Complex carbs fuel rising energy." },
