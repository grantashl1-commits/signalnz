  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center relative overflow-hidden px-6">
      ...
      >
        ...
        <Link
          to="/"
          className="inline-flex items-center gap-2 font-body text-xs tracking-wide text-foreground/60 border border-border rounded-full px-5 py-3 hover:border-foreground/30 hover:text-foreground/80 transition-all"
        >
          return home
        </Link>
      </motion.div>
